...
\TODO{Results cannot be generalized because they are specific to study areas but AIRs can be replicated and we
	provide a template}
...
\begin{figure}[htb]
	...
	\caption{Regions where \ac{AIRs} have been built.}
	\label{fig:AIR_regions}
\end{figure}

\ac{AIRs} built in the Himalayas, Andes and the Alps show drastic ice volume variations (Fig. \ref{fig:AIR_regions}).
...
\TODO{This is actually not true as we wrote in Paper I the following sentences in the Conclusion:
	The ice volume achieved after the accumulation period was
	much higher for the Indian AIR compared to the Swiss AIRs.
	The lower net radiation fluxes of the Indian location favored a faster thickness growth and the spray radius of the Indian
	fountain produced a higher surface area compared to the Swiss counterparts. Thus, the more than three times higher mean surface area and four times higher mean thickness growth during the two times shorter accumulation period of the Indian location
	resulted in a four times higher maximum ice volume of the Indian AIR compared to the Swiss.}
...
\TODO{Highlight the poor assumptions of the model}
