...
topography to amass a seasonal stock of ice. However, these three requirements can vary drastically based on
spatio-temporal patterns . Therefore, datasets of high resolution are necessary to judge any location's AIR
suitability. 
