...
for climate adaptation. Because of the challenges and cost related to manual storage efforts, AIRs can be
...
Paper I has shown that manual ice stupa construction systems suffer from overwatering. For example, in
...
manual and automated construction strategies. First, two AIRs were built in the same location but with and
