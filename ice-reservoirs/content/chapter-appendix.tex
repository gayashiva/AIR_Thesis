...
Ice is very transparent to \ac{GPR} signals, allowing tremendous penetration. \ac{GPR} is also sensitive to
subtle changes in the properties of ice layers. This makes it a powerful tool to image the internal structure of
glaciers and ice sheets at a scale of meters or hundreds of meters. The basic principle of a pulsed \ac{GPR}
system is to send an electromagnetic signal into the ground and to record the signal reflections as a function
of their two-way travel time. Partial reflections of the electromagnetic wave recorded as internal reflection
horizons (IRH) occur at vertical discontinuities in the dielectric material. From polar studies, IRH are known
to coincide with variations in density, acidity (Robin et al., 1969), liquid water content (Forster et al.,
2014) and changes in crystal orientation fabric. Therefore, \ac{GPR} is a viable method to map internal
structure of artificial ice reservoirs(AIR) and another way to validate their volume. 

\ac{GPR} survey has been conducted on four ice stupas at locations namely Phaterak, Gangles, Kullum and
Takmachik in March 2020. These data sets are provided at \url{https://doi.org/10.5281/zenodo.7056646}


Particular objectives were the following:

\begin{enumerate}

  \item{\textbf{Volume validation} : GPR surveys could be used to validate volumes of AIRs.}
  \item{\textbf{Spatial density resolution} : GPR data could help identify air, snow and ice layers within the AIR.}
