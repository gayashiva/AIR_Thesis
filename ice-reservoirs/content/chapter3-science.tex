...
water supply. Those that did were codenamed "automated" whereas the rest were codenamed
...
Several parametrizations are available for estimating each of the surface processes in COSIPY. Most of the
parametrizations used in the AIR model are among these options. But some parametrizations required minor
