...
\subsection{Initialisation and calibration requirements}
...
\%, 25 and 65 \% of the maximum area of the respective AIRs. There are two crude assumptions that lead to such a
largererror namely, assuming a conical shape and assuming a constant spray radius.

\subsection{Uncertainty in validation datasets}
