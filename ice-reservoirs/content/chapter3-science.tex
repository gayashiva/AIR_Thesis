...
regions (Alps and the Himalayas). Then we describe all the shape, mass and energy balance modules that were used
...
had dedicated teams that were capable to manage the construction and measurement campaigns.
...
\begin{table}[ht]
  ...
  italic). }      
	...
	\begin{tabular}{|llll|}
		...
		\textit{Documentation} & \textit{Paper III} & \textit{Paper I} & \textit{\citet{sauterCOSIPYV1Opensource2020} and Section \ref{sec:Cosistupa}}     \\ \hline
		Shape evolution        & Simplified         & Full         & Full                     \\
		Energy balance         & No temperature & 1-D temperature & 2-D temperature \\
		                       &           variation &        variation & variation \\ \hline
	\end{tabular}
\end{table}
...
winters, etc. It simulated ice stupa evolution using data from field measurements in Val Roseg, Switzerland. 
...
and an RMSE less than 18 \% of the maximum ice volume for three AIRs (Paper I). 
