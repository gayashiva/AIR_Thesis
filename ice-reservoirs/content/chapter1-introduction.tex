...
\ac{AIRs} in bridging the critical gap in water availability. Adapted from \cite{nusserLocalKnowledgeGlobal2016}}
...
management in these regions. Notably, none of these prior reports have investigated \ac{AIRs} outside Ladakh.
Moreover, quantifications of water storage capacity of \ac{AIRs} in Ladakh vary widely between these studies
...
A spirit of improvisation guides the construction strategies of \ac{AIRs} \citep{clouseLadakhArtificialGlaciers2017}.
Depending on the topography of the construction location and how water is supplied, \ac{AIRs} can form as flat sheets
...
glaciers are considered as natural ice reservoirs, we use the terminology \ac{AIRs} to distinguish the man-made
ice structures described in this thesis from the natural ones. 

However, when classified in terms of size and survival duration, \ac{AIRs} exhibit similar characterestics to
...
As has been noted above, a spirit of improvisation guides the construction strategy of \ac{AIRs} challenging their
...
An energy and mass balance model for \ac{AIRs} was set up to answer the first research question
