...
availability \citep{lutzConsistentIncreaseHigh2014}. The transformative effects of these changes on 
high mountain glacial hydrology are increasingly well understood, with peak water emerging as an accepted 
framework for the hydrological implications of glacial recession \citep{hussGlobalscaleHydrologicalResponse2018}. 
The peak water model illustrates the hydrological response of glacier-fed rivers to 
climate change over many years, indicating that warming initially drives increasing discharge until 
a glacier mass loss threshold is surpassed and discharge falls below values observed prior to contemporary climate warming 
\citep{baraerGlacierRecessionWater2012}. These changes are believed to be largely and negatively
...
\begin{figure}[htb] \centering \includegraphics[width=\textwidth]{figs/irrigation_cycles.png}
	\caption{Simplified representation of seasonal variation in water availability in Ladakh, India. The graph highlights the
...
held by the farming communities building these structures.
...
In addition to the chapters mentioned above, the \textit{Tradition} chapter illustrates the origin of ice
